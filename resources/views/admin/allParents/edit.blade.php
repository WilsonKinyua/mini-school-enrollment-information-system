...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.allParent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.all-parents.update", [$allParent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('guardian') ? 'is-invalid' : '' }}" name="guardian" id="guardian" required>
                    ...
                    @foreach(App\Models\AllParent::GUARDIAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('guardian', $allParent->guardian) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $allParent->first_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $allParent->surname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}" type="text" name="occupation" id="occupation" value="{{ old('occupation', $allParent->occupation) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="text" name="id_number" id="id_number" value="{{ old('id_number', $allParent->id_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('p_o_box') ? 'is-invalid' : '' }}" type="text" name="p_o_box" id="p_o_box" value="{{ old('p_o_box', $allParent->p_o_box) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('town') ? 'is-invalid' : '' }}" type="text" name="town" id="town" value="{{ old('town', $allParent->town) }}" required>
                @if($errors->has('town'))
                    <div class="invalid-feedback">
                        {{ $errors->first('town') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('town_code') ? 'is-invalid' : '' }}" type="text" name="town_code" id="town_code" value="{{ old('town_code', $allParent->town_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $allParent->phone_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('landline') ? 'is-invalid' : '' }}" type="text" name="landline" id="landline" value="{{ old('landline', $allParent->landline) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guardian_email') ? 'is-invalid' : '' }}" type="email" name="guardian_email" id="guardian_email" value="{{ old('guardian_email', $allParent->guardian_email) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $allParent->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('student') ? 'is-invalid' : '' }}" name="student_id" id="student_id" required>
                    @foreach($students as $id => $entry)
                        <option value="{{ $id }}" {{ (old('student_id') ? old('student_id') : $allParent->student->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
