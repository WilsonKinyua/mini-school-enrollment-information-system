...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.allStudent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.all-students.update", [$allStudent->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="surname">{{ trans('cruds.allStudent.fields.surname') }}</label>
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $allStudent->surname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $allStudent->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('p_o_box') ? 'is-invalid' : '' }}" type="text" name="p_o_box" id="p_o_box" value="{{ old('p_o_box', $allStudent->p_o_box) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('town') ? 'is-invalid' : '' }}" type="text" name="town" id="town" value="{{ old('town', $allStudent->town) }}" required>
                @if($errors->has('town'))
                    <div class="invalid-feedback">
                        {{ $errors->first('town') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('town_code') ? 'is-invalid' : '' }}" type="text" name="town_code" id="town_code" value="{{ old('town_code', $allStudent->town_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $allStudent->phone_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $allStudent->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $allStudent->village) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('county') ? 'is-invalid' : '' }}" name="county" id="county" required>
                    ...
                    @foreach(App\Models\AllStudent::COUNTY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('county', $allStudent->county) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country" id="country" required>
                    ...
                    @foreach(App\Models\AllStudent::COUNTRY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('country', $allStudent->country) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $allStudent->date_of_birth) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('religion') ? 'is-invalid' : '' }}" name="religion" id="religion">
                    ...
                    @foreach(App\Models\AllStudent::RELIGION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('religion', $allStudent->religion) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                    ...
                    @foreach(App\Models\AllStudent::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $allStudent->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kcpe_grade') ? 'is-invalid' : '' }}" type="text" name="kcpe_grade" id="kcpe_grade" value="{{ old('kcpe_grade', $allStudent->kcpe_grade) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kcpe_total_marks') ? 'is-invalid' : '' }}" type="number" name="kcpe_total_marks" id="kcpe_total_marks" value="{{ old('kcpe_total_marks', $allStudent->kcpe_total_marks) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('disabled') ? 'is-invalid' : '' }}" name="disabled" id="disabled" required>
                    ...
                    @foreach(App\Models\AllStudent::DISABLED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('disabled', $allStudent->disabled) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $allStudent->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admission_number') ? 'is-invalid' : '' }}" type="text" name="admission_number" id="admission_number" value="{{ old('admission_number', $allStudent->admission_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $allStudent->status) }}" step="1" required>
