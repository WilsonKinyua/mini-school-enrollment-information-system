...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-types.update", [$userType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="image">{{ trans('cruds.userType.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.userType.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    url: '{{ route('admin.user-types.storeMedia') }}',
    maxFilesize: 2, // MB
    ...
    init: function () {
@if(isset($userType) && $userType->image)
      var file = {!! json_encode($userType->image) !!}
