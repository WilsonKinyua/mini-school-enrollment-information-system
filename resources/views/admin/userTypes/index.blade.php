...
<div class="card mt-5">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-UserType">
            <thead>
                <tr>
                    <th width="10">
...
@can('user_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.user-types.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.user-types.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-UserType').DataTable(dtOverrideGlobals);
